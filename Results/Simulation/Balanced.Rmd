...
ggsave(paste0("pest_main_",sub(".*_(.*)\\.rds", "\\1", i), ".png"), width = 6, height = 3, dpi = 360, units = "in", device = "png")
...
re  %>% 
  filter(!Metric %in% c("FNR", "FPR")) %>%
    ...
    ylim(0, 2.5)
ggsave(paste0("re_main_",sub(".*_(.*)\\.rds", "\\1", i), ".png"), width = 6, height = 3, dpi = 360, units = "in", device = "png")
